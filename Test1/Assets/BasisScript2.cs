...
public class BasisScript2 : MonoBehaviour {
	...
	void Start()
	{
		...
		var xml = File.ReadAllText("Assets/SVG/Test1.SVG");
        ...
        Camera.main.GetComponent<CameraBehaviour>().target = Building.transform;
